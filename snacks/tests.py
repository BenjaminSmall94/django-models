...
class ThingsTests(TestCase):
    def setUp(self):
        ...
        Snack.objects.create(name="butterfingers", purchaser=purchaser, description="Test")
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].name, "butterfingers")
    ...
    def test_detail_page_context(self):
        ...
        self.assertEqual(snack.name, "butterfingers")
